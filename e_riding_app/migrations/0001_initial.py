    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pair_rider', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Step',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='team_horse', to='e_riding_app.Horse')),
                ('rider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='team_rider', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='VetCard',
        ...
        migrations.AddField(
            model_name='pair',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pair_team', to='e_riding_app.Team'),
        ),
        migrations.AddField(
            model_name='pair',
            name='vet_card_on_start',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pair_vet_card_on_start', to='e_riding_app.VetCard'),
        ),
        migrations.AddField(
